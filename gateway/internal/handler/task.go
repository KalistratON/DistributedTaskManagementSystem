...
// func CheckAuth(rqs types.VerifingRequest) bool {
...
// 	reqeustGrpc := &pb.VerifingRequest{Token: rqs.Token}
// 	responseGrpc, err := client.Verifing(context.Background(), reqeustGrpc)
// 	if responseGrpc == nil {
...
// 	if responseGrpc.UserId == "-1" {
// 		log.Printf("user is not authificate")
// 		return false
// 	}
